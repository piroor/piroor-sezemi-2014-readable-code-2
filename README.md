# SEゼミ リーダブルコード勉強会 第2回（2014年7月6日）
 ...
 * 業務では、Mozilla Firefox/Thunderbirdの企業導入のサポートや、全文検索エンジン[Groonga](http://groonga.org/)の関連プロダクト（最近では特に[Droonga](http://droonga.org/)）の開発などに従事しています。
